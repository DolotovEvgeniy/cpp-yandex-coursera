...
using Tree = array<double, VERTEX_COUNT>;
Tree tree_add_values, tree_spent_values, tree_add, tree_spent, tree_factor;
...
double ComputeSum(const Tree& tree_op_values, size_t v, size_t l, size_t r, size_t ql, size_t qr) {
...
void Add(Tree& tree_op_values, Tree& tree_op, size_t v, size_t l, size_t r, size_t ql, size_t qr, double value) {
  if (v >= VERTEX_COUNT || qr <= l || r <= ql) {
    return;
  }
  Push(v, l, r);
